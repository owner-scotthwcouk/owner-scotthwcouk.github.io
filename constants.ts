    ...
    React.createElement('div', null,
        ...
        React.createElement('div', { className: "space-y-6" },
            React.createElement('div', { className: "border-l-2 border-voyager-orange pl-4" },
                React.createElement('h4', { className: "text-xl text-voyager-tan font-bold" }, "Project Nebula"),
                React.createElement('p', { className: "text-sm text-voyager-blue" }, "Stardate: 2023.Q4"),
                React.createElement('p', { className: "mt-2" }, "Developed a real-time data visualization dashboard for tracking interstellar fleet movements. Utilized React, D3.js, and WebSockets to handle high-frequency updates, ensuring 99.9% uptime and data accuracy for command-level decision making.")
            ),
            React.createElement('div', { className: "border-l-2 border-voyager-orange pl-4" },
